# DASH Manifest Examples<a name="dash-manifest-examples"></a>

**DASH origin MPD example**  
The following example from an MPD manifest shows an ad\-break `Period` in a manifest received by DASH from the content origin:
...
**DASH personalized response MPD example**  
